...
message.send_keys("Bonjour. Je suis un particulier. Je suis dans la region parisienne. \n"+
                  ...
                  "1) Le terrain est-il toujours en vente s'il vous plait ? \n" +
                  "2) Le terrain est-il constructible s'il vous plait ? \n" +
                  "2_bis) Est-il possible de faire une exploitation agricole sur le terrain s'il vous plait ? \n" +
                  ...
                  "8) Y a-t-il l'existence d'hypotheques sur le terrain s'il vous plait ? \n" +
                  ...
                  "14) Est-ce que la conformite de l'installation d'assainissement individuel du terrain est bien respectee s'il vous plait ? \n" +
                  ...
                  "22) Y a-t-il la presence d'une boite aux lettres s'il vous plait ? \n" +
