...
message.send_keys("Bonjour. Je suis un particulier. Je suis dans la region parisienne. \n"+
                  ...
                  "1) La cave est-elle toujours en vente s'il vous plait ? \n" +
                  "3) Etes-vous le proprietaire de la cave s'il vous plait ? \n" +
                  "8) Y a-t-il l'existence d'hypotheques sur la cave s'il vous plait ? \n" +
                  ...
                  "\n" +
                  "Urbanisme \n" +
                  "21) Pourriez-vous me donner l'adresse de la cave s'il vous plait ? \n" +
